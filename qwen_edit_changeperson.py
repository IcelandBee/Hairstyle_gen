...
OUTPUT_DIR = "/DATA_71/b59900515/data/candidate_hair/ref"

MODEL_PATH = "/DATA/b59900515/models/Qwen-Image-Edit-2509"
...
def load_pipeline(model_path, device):
    ...
    # 如需加载 LoRA，可取消注释：
    # pipe.load_lora_weights("/DATA/b59900515/models/Edit-R1-Qwen-Image-Edit-2509")
    # print(f"[GPU {device}] Load UNIworld lora")
